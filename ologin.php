...
<div class="container">
    ...
    <div style="width: 400px;margin-left: 35%;margin-top: 2%;box-shadow: 0px 0px 5px #660066;padding:20px">
        <div style='text-align: center;padding:20px;background:  linear-gradient(To top right,#033,#3cc);color:white;border-radius: 25% 25% 0% 0%'>Owner Login</div>
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button class="btn btn-warning" name="ownerBtn" type="submit" class="btn btn-default">Submit</button>
    </div>
  </div>
</form>
</div>
