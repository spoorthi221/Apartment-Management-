...
<body style="background-image: url(img/t.jpg);background-repeat: no-repeat;background-size: cover;">
...
<div class="container">
    ...
    <div style="width: 400px;margin-left: 35%;box-shadow: 0px 0px 5px #660066;padding:20px;">
        <div style='text-align: center;padding:20px;background-image: linear-gradient(to right, #3E5151 , #DECBA4); border-radius: 15% 25% 0% 25%'>Tenant Login</div>
